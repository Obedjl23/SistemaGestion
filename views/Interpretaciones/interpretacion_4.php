      ...
      <nav class="sb-sidenav accordion sb-sidenav-dark  " style="background: #008590; 
        ...
        <div class="sb-sidenav-menu">
          ...
          <div class="nav">
            ...
            <a class="nav-link fw-bold" style="color:#323232" href="../Interpretaciones/introduccio.php">
    ...
    <div id="layoutSidenav_content">
      <main>
        ...
        <div class="title">
          ...
          <h1>Interpretación de los Requisitos de la Norma ISO 9001:2015 S4</h1>


        </div>

        <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/aBhz82NUYi0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
