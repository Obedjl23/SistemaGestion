...
if ($id_empresa['id_empresa'] == 1) { //admin
  $sel = $con->query("SELECT per.id, per.title, per.description, per.url, emp.emp_nombre from infraestructura per
  ...
  $sel = $con->query("SELECT * FROM infraestructura WHERE id_empresa = '$id_empresa'");
  while ($row = $sel->fetch_assoc()) {
    $tmp = $row;
    array_push($res, $tmp);
  }
          ...
          <div class="nav">
            ...
            <div class="collapse" style="color:#323232" id="collapseRecursos" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                ...
                <a class="nav-link" style="color:#323232" href="index.php">Infrestuctura</a>
        ...
        <div class="container">
          <div class="row justify-content-md-center">
            <div class="col-md-auto">
              <h1 <i class="fa fa-align-center fw-bold" aria-hidden="true">INFRAESTRUCTURA</i></h1>
              ...
              <table class="table mt-2">
                ...
                <tbody>
                 ...
                 <?php } ?>
                      ...
                      <td>
                        <a class="btn btn-primary" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/views/Infraestructura/' . $val['url']; ?>">Ver Archivo pagina</a>
