...
if ($id_empresa['id_empresa'] == 1) { //admin
  $sel = $con->query("SELECT per.id, per.title, per.description, per.url, emp.emp_nombre from objetivos per
  ...
  $sel = $con->query("SELECT * FROM objetivos WHERE id_empresa = '$id_empresa'");
  while ($row = $sel->fetch_assoc()) {
    $tmp = $row;
    array_push($res, $tmp);
  }
      ...
      <nav class="sb-sidenav accordion sb-sidenav-dark  " style="background: #008590; 
        ...
        <div class="sb-sidenav-menu">
          ...
          <div class="nav">
            ...
            <a class="nav-link fw-bold" style="color:#323232" href="../Objetivoindex.php">
        ...
        <div class="container">
          <div class="row justify-content-md-center">
            <div class="col-md-auto">
              <h1 <i class="fa fa-align-center fw-bold" aria-hidden="true">OBJETIVO</i></h1>
              ...
              <table class="table mt-2">
                ...
                <tbody>
                 ...
                 <?php } ?>
                      ...
                      <td>
                        <a class="btn btn-primary" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/views/Objetivo/' . $val['url']; ?>">Ver Archivo pagina</a>
