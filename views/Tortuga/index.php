...
if ($id_empresa['id_empresa'] == 1) { //admin
  $sel = $con->query("SELECT per.id, per.title, per.description, per.url, emp.emp_nombre from tortuga per
        ...
        <div class="container">
          <div class="row justify-content-md-center">
            <div class="col-md-auto">
              <h1 <i class="fa fa-align-center fw-bold" aria-hidden="true">DIAGRAMA DE TORTUGA</i></h1>
              ...
              <table class="table mt-2">
                ...
                <tbody>
                 ...
                 <?php } ?>
                      ...
                      <td>
                        <a class="btn btn-primary" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/views/Tortuga/' . $val['url']; ?>">Ver Archivo pagina</a>
