...
if ($id_empresa['id_empresa'] == 1) { //admin
  $sel = $con->query("SELECT * FROM infraestructura");
  ...
  $sel = $con->query("SELECT * FROM   archivoWHERE id_empresa = '$id_empresa'");
  while ($row = $sel->fetch_assoc()) {
    $tmp = $row;
    array_push($res, $tmp);
  }
          ...
          <div class="nav">
                ...
                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                  ...
                  <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                    <nav class="sb-sidenav-menu-nested nav">
                      <a class="nav-link" style="color:#323232" href="../Interpretaciones/interpretacion_5.php">Sesion 1</a>
                      <a class="nav-link" style="color:#323232" href="../Interpretaciones/interpretacion_6.php">Sesion 2</a>
                      <a class="nav-link" style="color:#323232" href="../Interpretaciones/interpretacion_7.php">Sesion 3</a>
                      <a class="nav-link" style="color:#323232" href="../Interpretaciones/interpretacion_8.php">Sesion 4</a>
                    </nav>
                  </div>
              </div>
            <?php
            ...
            <div class="collapse" style="color:#323232" id="collapseOrganisacion" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                ...
                <div class="collapse" style="color:#323232" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                  <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" style="color:#323232" href="../Objetivo/user.php">
                      Objetivos</a>
                  </nav>
                </div>
                ...
                <div class="collapse" style="color:#323232" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                  <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" style="color:#323232" href="../infraestructura/user.php">infraestructura</a>
                    <a class="nav-link" style="color:#323232" href="../Foda/user.php">Foda</a>
                    <a class="nav-link" style="color:#323232" href="../Partes_infraestructura/user.php">Partes infraestructura</a>
                  </nav>
                </div>
                <a class="nav-link fw-bold" style="color:#323232" href="../Comunicacion/user.php">
            ...
            <div class="collapse" style="color:#323232" id="collapseProceso" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                ...
                <div class="collapse" style="color:#323232" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                  <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" style="color:#323232" href="../infraestructura/user.php">Diagrama de infraestructura</a>
                    <a class="nav-link" style="color:#323232" href="../infraestructura/user.php">Diagrama infraestructura</a>
                    <a class="nav-link" style="color:#323232" href="../General/user.php">Diagrama General</a>
                  </nav>
                </div>
            </div>
            ...
            <a class="nav-link fw-bold" style="color:#323232" href="../infraestructura_Oportunidades/user.php">
              <div class="sb-nav-link-icon" style="color:#323232"><ion-icon name="shield-half" style="color:#000000"></ion-icon></div>infraestructura&Oportunidades
            </a>
            ...
            <div class="collapse" style="color:#323232" id="collapseRecursos" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" style="color:#323232" href="../CrudPersonal/user.php">Personal</a>
                <a class="nav-link" style="color:#323232" href="../Infraestructura/user.php">Infrestuctura</a>
                <a class="nav-link" style="color:#323232" href="../ archivo/user.php">Info.Documental</a>
              </nav>
            </div>

            <a class="nav-link fw-bold" style="color:#323232" href="user.php">
              <div class="sb-nav-link-icon" style="color:#323232"><ion-icon name="keypad" style="color:#000000"></ion-icon></div>
              Operación
            </a>

            <a class="nav-link fw-bold" style="color:#323232" href="../Proveedores/user.php">
              <div class="sb-nav-link-icon" style="color:#323232"><ion-icon name="people-circle" style="color:#000000"></ion-icon></div>
              Provedores
            </a>

            <a class="nav-link fw-bold" style="color:#323232" href="../Desempeño/user.php">
              <div class="sb-nav-link-icon" style="color:#323232"><ion-icon name="cog" style="color:#000000"></ion-icon></div>
              Desempeño
            </a>

            <a class="nav-link fw-bold" style="color:#323232" href="../Mejora/user.php">
