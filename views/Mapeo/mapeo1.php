            ...
            <div class="collapse" id="collapseCapacitacion" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                ...
                <div class="collapse" id="pagesCollapseAuth1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                  <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" style="color:#323232" href="mapeo1.php">Sesion 1</a>
                    <a class="nav-link" style="color:#323232" href="mapeo2.php">Sesion 2</a>
                    <a class="nav-link" style="color:#323232" href="mapeo3.php">Sesion 3</a>
                    <a class="nav-link" style="color:#323232" href="mapeo4.php">Sesion 4</a>
                  </nav>
                </div>
    ...
    <div id="layoutSidenav_content">
      <main>
        ...
        <div class="title">
            ...
            <h1>Mapeo de Procesos S1</h1>
            
            
            </div>
            
            <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/1DXdoFbvglQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>   
            <div class="container-fluid d-flex flex-row-reverse bd-highlight my-1 px-3">
              
              <a href="./documentos/mapeo3tortuga.html" style="margin: 30px;" type="button" class="btn btn-outline-dark fw-bold">DIAGRAMA DE TORTUGA</a>
              <h1></h1>
              <a href="./documentos/mapeo2presentacion.html" style="margin: 30px;" type="button" class="btn btn-outline-dark fw-bold">PRESENTACIÓN - MAPEO DE PROCESOS</a>
              <h1></h1>
              <a href="./documentos/mapeo1temario.html" style="margin: 30px;" type="button" class="btn btn-outline-dark fw-bold">TEMARIO - MAPEO DE PROCESOS</a>
            </div>
