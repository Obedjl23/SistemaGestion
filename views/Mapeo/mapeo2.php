    ...
    <div id="layoutSidenav_content">
      <main>
        ...
        <div class="title">
            ...
            <h1>Mapeo de Procesos S2</h1>
            
            
            </div>
            
            <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/Mn6VvsVBpz0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  
            <div class="container-fluid d-flex flex-row-reverse bd-highlight my-1 px-3">
              
              <a href="./documentos/mapeo6pulpo.html" style="margin: 30px;" type="button" class="btn btn-outline-dark fw-bold">DIAGRAMA DE PULPO</a>
              <h1></h1>
              <a href="./documentos/mapeo5SIPOC.html" style="margin: 30px;" type="button" class="btn btn-outline-dark fw-bold">DIAGRAMA SIPOC</a>
              <h1></h1>
