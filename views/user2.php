          ...
          <div class="sb-sidenav-menu">
              ...
              <div class="nav">
                  <div class="sb-sidenav-menu-heading" style="color:#FFFF">Mapas</div>
                          ...
                          <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                              ...
                              <div class="collapse" style="color:#323232" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                  <nav class="sb-sidenav-menu-nested nav">
                                      <a class="nav-link" style="color:#323232" href="../Objetivo/user.php">Objetivos</a>
                                  </nav>
                              </div>
                              ...
                              <a class="nav-link fw-bold" style="color:#323232" href="../Comunicacion/user.html">
                      ...
                      <a class="nav-link fw-bold" style="color:#323232" href="../CrudArchivos/user.php">
