            ...
            <div class="collapse" id="collapseCapacitacion" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                ...
                <div class="collapse" id="pagesCollapseAuth3" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                  <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" style="color:#323232" href="auditores1.php">Sesion 1</a>
                    <a class="nav-link" style="color:#323232" href="auditores2.php">Sesion 2</a>
                    <a class="nav-link" style="color:#323232" href="auditores3.php">Sesion 3</a>
                    <a class="nav-link" style="color:#323232" href="auditores4.php">Sesion 4</a>
                  </nav>
                </div>
            ...
            <a class="nav-link collapsed fw-bold"  style="color:#323232"href="#" data-bs-toggle="collapse" data-bs-target="#pagesCollapseAuth1" aria-expanded="false" aria-controls="pagesCollapseAuth1">
                ...
                <div class="collapse" id="pagesCollapseAuth1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                  <nav class="sb-sidenav-menu-nested nav">
                    ...
                    <a class="nav-link" style="color:#323232" href="../Estrategico/index.phhp">Estrategico</a>
    ...
    <div id="layoutSidenav_content">
      <main>
        ...
        <div class="title">
            ...
            <h1>Auditores Internos de SGC - Norma ISO 19011-2018 S4</h1>
            
            
            </div>
            
            <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/rjyb3tBvvZI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            <div class="container-fluid d-flex flex-row-reverse bd-highlight my-1 px-3">
            
              <a href="./documentos/auditores2presentacion.html" style="margin: 30px;" type="button" class="btn btn-outline-dark fw-bold">PRESENTACIÓN - AUDITOR INTERNO</a>
              <h1></h1>
              <a href="./documentos/auditores1temario.html" style="margin: 30px;" type="button" class="btn btn-outline-dark fw-bold">TEMARIO - AUDITOR INTERNO</a>
